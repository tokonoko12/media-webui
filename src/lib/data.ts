...
export const trendingMovies: Movie[] = [
    ...
    },
    {
        id: 5,
        title: "Tron: Legacy",
        overview: "Sam Flynn, the tech-savvy and daring son of Kevin Flynn, investigates his father's disappearance and is pulled into The Grid, a digital world of fierce gladiatorial games and cybernetic programs.",
...
export const retroClassics: Movie[] = [
    {
        id: 6,
        title: "Akira",
        overview: "A secret military project endangers Neo-Tokyo when it turns a biker gang member into a rampaging psychic psychopath that only two veterans and a group of psychics can stop.",
    ...
    },
    {
        ...
        overview: "In the year 2029, the barriers of our world have been broken down by the net and by cybernetics, but this brings new vulnerability to humans in the form of brain-hacking. When a highly-wanted hacker known as 'The Puppet Master' begins involving them in politics, Section 9, a group of cybernetically enhanced cops, are called in to investigate and stop the Puppet Master.",
